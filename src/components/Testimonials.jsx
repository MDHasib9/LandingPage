...
// Keeping content separate from UI logic improves maintainability,
// scalability, and makes future CMS or API integration easier.
const testimonials = [
  {
    name: "Sarah Chen",
  ...
  },
  {
    ...
    role: "CTO",
    image:
      "https://t4.ftcdn.net/jpg/07/57/61/23/360_F_757612374_09Q9dyxOKbynCiT3hMUyk3iEuoR1RgJy.jpg",
    content:
...
export default function Testimonials() {
  return (
    // Section wrapper with semantic ID for anchor navigation
    <section
      id="testimonials"
      className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative"
    >
      <div className="max-w-7xl mx-auto">
        {/* Two-column layout: header on the left, testimonials on the right */}
        <div className="flex flex-col lg:flex-row items-start gap-8 sm:gap-12 lg:gap-16">
          
          {/* Left side — Section heading and description */}
          <div className="lg:w-1/2 w-full text-center lg:text-left">
            <h2 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6">
              What developers are saying about us
            </h2>

            {/* Supporting copy to provide context and value proposition */}
          ...
          <div className="lg:w-1/2 w-full">
            <div className="space-y-6 sm:space-y-8">
              ...
              {testimonials.map((testimonial, key) => (
                <div
                  // Index key is acceptable here due to static, non-reordered data
                  key={key}
